...
COLOR_NAMES = list(TABLEAU_COLORS) + ['blue', 'gold', 'lime', 'red', 'magenta', 'peru', 'navy',
                                      'dodgerblue', 'orangered', 'mediumspringgreen',
                                      'rebeccapurple', 'indianred', 'mediumslateblue', 'coral',
                                      'darkgoldenrod', 'olivedrab', 'palegreen', 'darkslategray',
                                      'steelblue', 'indigo', 'mediumvioletred']
